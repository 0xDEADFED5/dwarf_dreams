...
pub struct NestedBTree<T> {
    x65535y65535: BTreeMap<(u8, u8), BTreeMap<u8, T>>,
    x65535y255: BTreeMap<(u8, u8), BTreeMap<u8, T>>,
    x255y65535: BTreeMap<(u8, u8), BTreeMap<u8, T>>,
    x255y255: BTreeMap<(u8, u8), BTreeMap<u8, T>>,
}
...
impl<T> NestedBTree<T> {
    ...
    pub fn insert(self:&mut Self, x:u16, y:u16, z: u8, value: T) {
        if x > 255 && y > 255 {
